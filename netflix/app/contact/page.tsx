...
export default function ContactPage() {
  ...
  return (
    <div className="px-6 md:px-20 pt-12 md:mt-4 pb-20 text-white">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-10 mb-2 sm:mb-0 mt-6 xl:mt-10">
