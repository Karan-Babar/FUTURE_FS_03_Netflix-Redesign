...
export default function Navbar() {
  ...
  const linkStyle = (href: string) =>
    `relative pb-1 transition text-white/80 
     hover:text-red-600 
     after:absolute after:left-0 after:-bottom-[2px] after:h-[3px] after:bg-red-600 after:w-0 after:transition-all
     ${isActive(href) ? "text-red-600 after:w-full" : "hover:after:w-full"}`;
    ...
    <header className="fixed inset-x-0 top-0 z-40 bg-black/60 backdrop-blur-md border-b border-white/5">
      <div className="max-w-[1400px] mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          {/* NAV LINKS */}
          <nav className="hidden md:flex items-center gap-8 ml-10 text-lg cursor-pointer">
