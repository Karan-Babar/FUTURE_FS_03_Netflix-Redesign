...
function Hero() {
  return (
<section className="relative z-0 h-[50vh] md:h-[65vh] w-full">
      {/* Background image */}
       <div className="absolute inset-0 -z-10 scale-120 translate-x-40 -translate-y-5">
     <video
          src="/trailer2.mp4"
          autoPlay
          muted
  ...
  {/* <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/55" /> */}
      ...
      <div className="max-w-[1400px] mx-auto px-6 h-full flex items-end">
        <div className="pb-14 md:pb-22 w-full md:w-1/2">
          {/* Title image or text */}
          <div className="mb-4">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight ml-10">STRANGER THINGS SEASON 5</h1>
          </div>

          {/* meta + buttons */}
          <div className="flex items-center gap-4 mb-6">
            <span className="bg-yellow-400 text-black px-2 py-0.5 cursor-pointer rounded-md text-sm font-semibold ml-10">IMDb 8.2/10</span>
